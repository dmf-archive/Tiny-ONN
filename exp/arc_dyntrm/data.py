...
class InMemoryArcDataset(Dataset):
    def __init__(self, data_path: str, tokenizer: ArcColorTokenizer, split: str = "training", warmup_ratio: float = 1.0):
        ...
        for path in file_paths:
            ...
            if split == "training" and "test" in task_data and task_data["test"] and "output" in task_data["test"][0] or split == "evaluation" and "test" in task_data and task_data["test"]:
