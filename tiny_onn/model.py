...
class TinyOnnModel(TinyOnnPreTrainedModel):
    def __init__(self, config: TinyOnnConfig):
        ...
        self.layers = nn.ModuleList([TinyOnnDecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)])
...
class TinyOnnForCausalLM(TinyOnnPreTrainedModel):
    ...
    def forward(
        ...
        # Language model forward pass logic here
        pass
