...
为解决此问题，我们引入了**上下文感知路由一致性 (Context-Aware Routing Consistency, CARC)**。其核心思想是，路由策略的一致性不应是无条件的，而应由**输入的相似性**来动态决定：
...
### 全局路由策略指纹 (Global Routing Policy Fingerprint)
